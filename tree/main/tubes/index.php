...
// Query ke tabel petcare
$teknologi = query("SELECT * FROM petcare");
// Query tabel petcare sesuai keyword pencarian
if (isset($_GET["cari"])) {
  $keyword = $_GET["keyword"];
  $query = "SELECT * FROM petcare
              WHERE 
            nama LIKE '%$keyword%'";
  $petcare = query($query);
}
...
<head>
  ...
  <title>Pedd Clinic</title>
</head>

<body>

  <div class="container">
    <h1 class="align-midcle">Pedd Clinic</h1>
    ...
    <div class="intro">
      <h2 class="text-center" id="Produk" style="margin-top: 110px">Petcare</h2>
    </div>
    <div class="tab-content">
      <div class="row">
        <?php if (empty($petcare)) : ?>
          <div class="col-md-12">
